 ...
 * @api
 */
class Tx_InfiniteScrollGallery_ViewHelpers_Form_SelectViewHelper extends Tx_Fluid_ViewHelpers_Form_AbstractFormFieldViewHelper {
	...
	protected function getOptions() {
		...
		/*-------add method emptyOption----------*/
		// this code has been added because we are lacking this option in the default View Helper
		if ($this->arguments->hasArgument('emptyOption')) {
			$options = array('0' => $this->arguments['emptyOption']) + $options;
		}
		return $options;
	}
